...
def tsc_to_json_for_RTE(tsc_file_path=None, json_file_path=None):
    base_file_path = '/home/1004chr/FedPETuning/data/glue_data/RTE'  # 替换为你的 TSC 文件路径
...
if __name__ == "__main__":
    # tsc_to_json_for_RTE() # can not use load_dataset func.
